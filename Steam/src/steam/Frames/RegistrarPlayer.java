...
public class RegistrarPlayer { 
    ...
    public static JPanel createPanel() {
        ...
        gdc.gridx = 0; gdc.gridy = 1; p.add(new JLabel("Username:"), gdc);
        gdc.gridx = 1; p.add(new JTextField(30), gdc);

        gdc.gridx = 0; gdc.gridy = 2; p.add(new JLabel("Password:"), gdc);
        gdc.gridx = 1; 
        ...
        gdc.gridx = 0; gdc.gridy = 3; p.add(new JLabel("Nombre:"), gdc);
        gdc.gridx = 1; p.add(new JTextField(30), gdc);

        gdc.gridx = 0; gdc.gridy = 4; p.add(new JLabel("Fecha de nacimiento:"), gdc);
        gdc.gridx = 1; 
        dateChooser.setDateFormatString("dd/MM/yyyy");
        dateChooser.setPreferredSize(new Dimension(150, 30));
        p.add(dateChooser, gdc);

        gdc.gridx = 0; gdc.gridy = 5; p.add(new JLabel("Imagen (preview):"), gdc);
        gdc.gridx = 1;
        ...
        gdc.gridx = 0; gdc.gridy = 7; p.add(new JLabel("Tipo usuario:"), gdc);
        gdc.gridx = 1; p.add(new JComboBox<>(new String[]{"normal", "admin"}), gdc);

        gdc.gridx = 0; gdc.gridy = 8; gdc.gridwidth = 2;
        JButton btnRegister = new JButton("Registrar");
        btnRegister.setPreferredSize(new Dimension(220, 44));
        btnRegister.addActionListener(ae -> JOptionPane.showMessageDialog(p, "Player listo para guardar."));
    ...
    private static void handleImageSelection(JLabel previewLabel) {
        ...
        int result = fileChooser.showOpenDialog(null); // Usamos null o el parent
